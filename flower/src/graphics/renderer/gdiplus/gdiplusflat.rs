// use gdiplus_sys2::{ARGB, ColorAdjustType, ColorPalette, CustomLineCapType, EncoderParameters, GetThumbnailImageAbort, GpCustomLineCap, GpFillMode, GpFlushIntention, GpGraphics, GpImage, GpImageAttributes, GpLineCap, GpLineGradient, GpMatrix, GpMatrixOrder, GpMetafile, GpPath, GpPathData, GpPathGradient, GpPen, GpPoint, GpPointF, GpRect, GpRectF, GpStatus, GpUnit, GpWrapMode, GraphicsContainer, ImageType, MetafileHeader, PixelFormat, REAL, WmfPlaceableFileHeader};
// use winapi::shared::guiddef::{CLSID, GUID};
// use winapi::shared::minwindef::{BOOL, BYTE, HMETAFILE, UINT};
// use winapi::shared::windef::{HDC, HENHMETAFILE};
// use winapi::um::objidlbase::IStream;
// use winapi::um::winnt::{HANDLE, INT, VOID, WCHAR};
//
// extern "system" {
